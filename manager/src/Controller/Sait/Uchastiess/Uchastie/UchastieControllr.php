...
namespace App\Controller\Sait\Uchastiess\Uchastie;
...
/**
 * @Route("/sait/uchastiess/uchastie", name="sait.uchastiess.uchastie")
 */
class UchastieControllr extends AbstractController
{
                            ...
                            ): Response
    {
        ...
        return $this->render('sait/uchastiess/uchastie/index.html.twig',
...
// следующие присваения перенести в Handler не можeм т.к. инфа  из $user
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                return $this->redirectToRoute('sait.uchastiess.uchastie');
        ...
        return $this->render('sait/uchastiess/uchastie/create.html.twig', [
    ...
    public function show(UchastieRepository $uchasties, string $id): Response
    {
       ...
       // dd($uchastie);
        return $this->render('sait/uchastiess/uchastie/show.html.twig',
            compact('uchastie')
        );
    }
