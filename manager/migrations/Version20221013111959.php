 ...
 */
final class Version20221013111959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE paseka_rasa_linia_nomers ADD CONSTRAINT FK_D8F86179400E94F9 FOREIGN KEY (linia_id) REFERENCES paseka_rasa_linias (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE paseka_rasa_linia_nomers ADD CONSTRAINT FK_D8F861795FE9B039 FOREIGN KEY (sparing_id) REFERENCES paseka_rasa_linia_nomer_sparings (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rabota_rasa_linia_nomers DROP CONSTRAINT FK_D8F861795FE9B039');
        $this->addSql('ALTER TABLE rabota_rasa_linia_nomers DROP CONSTRAINT FK_D8F86179400E94F9');
