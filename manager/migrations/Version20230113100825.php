 ...
 */
final class Version20230113100825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sezon_goda_wzatoks ALTER gruppa TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE sezon_goda_wzatoks ALTER gruppa DROP DEFAULT');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sezon_goda_wzatoks ALTER goda_id TYPE UUID');
        $this->addSql('ALTER TABLE sezon_goda_wzatoks ALTER goda_id DROP DEFAULT');
        $this->addSql('ALTER TABLE sezon_goda_wzatoks ALTER gruppa TYPE SMALLINT');
        $this->addSql('ALTER TABLE sezon_goda_wzatoks ALTER gruppa DROP DEFAULT');
    }
}
