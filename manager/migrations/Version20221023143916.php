 ...
 */
final class Version20221023143916 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE paseka_matkas_sparings (id UUID NOT NULL, name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN paseka_matkas_sparings.id IS \'(DC2Type:paseka_matkas_sparing_id)\'');
        $this->addSql('CREATE TABLE paseka_rasa_linia_nomers (id UUID NOT NULL, linia_id UUID NOT NULL, name VARCHAR(255) NOT NULL, name_star VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, sort_nomer INT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE paseka_matkas_sparings');
